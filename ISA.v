...
`define SRAM_ENABLE 1'b0 // ? Active Low
`define SRAM_DISABLE 1'b1
`define SIZE_SRAM_DATA_MEMORY 512
`define LEN_SRAM_DATA_BUS 32
`define LEN_SRAM_ADDRESS_BUS 18
`define LEN_SRAM_COUNTER 3

`define LEN_SRAM_STATE 2
`define STATE_SRAM_IDLE 2'b00
`define STATE_SRAM_READ 2'b01
`define STATE_SRAM_WRITE 2'b10
